...
\newcommand{\figcaption}[1]{{\begin{flushright}\usebeamercolor[fg]{structure} \it #1 \end{flushright}}}

\newcommand{\finger}[1]{\parbox[t]{4.2em}{\vspace{-0.2em}\hspace{-1em}\includegraphics[width=4em]{images/finger_right}}\parbox[c]{.9\textwidth}{#1}}
