...
1. stationary distribution is long-term fitness

2. $\sigma_e$ is determined by $L_t$
...
With a reversible-in-time Markovian environment,
at stationarity,
with the *same* distribution in space,
